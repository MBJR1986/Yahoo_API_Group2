...
class UpdateData():
    ...
    def UpdateTransactions(self):
        ...
        load_file = open('C:/Users/mabur/Yahoo_API_Group2/transactions/Transaction_old.json') # load old_transactions
        old_transactions = json.load(load_file)
        load_file.close()

        load_file = open('C:/Users/mabur/Yahoo_API_Group2/transactions/Transaction_new.json') # load new_transactions (this will get written over once we download the newest data from Yahoo)
        new_transactions = json.load(load_file)
        load_file.close()

        with open('C:/Users/mabur/Yahoo_API_Group2/transactions/Transaction_old.json', 'w') as outfile: # save the new*_transactions as old so we can compare the actual new transactions
            json.dump(new_transactions, outfile)

        load_file = open('C:/Users/mabur/Yahoo_API_Group2/transactions/Transaction_old.json') # now load the *new* old_transactions as the base for comparison
        old_transactions = json.load(load_file)
        load_file.close()
        ...
        r = response.json()
        with open('C:/Users/mabur/Yahoo_API_Group2/transactions/Transaction_new.json', 'w') as outfile:
            json.dump(r, outfile)
        #### load in newest transaction data
        load_file = open('C:/Users/mabur/Yahoo_API_Group2/transactions/Transaction_new.json')
        new_transactions = json.load(load_file)
        load_file.close()
        ...
        team_numbers = {}
        with open('C:/Users/mabur/Yahoo_API_Group2/teams/team_numbers.txt', 'r') as f:
            #for line in f:
    ...
    def UpdateScoreboards(self):
        ...
        while week < num_weeks+1: #assumes 16 week-schedule
            ...
            with open('C:/Users/mabur/Yahoo_API_Group2/weekly_scoreboard/'+file_name, 'w') as outfile:
                json.dump(r, outfile)
            week += 1
        return;
    ...
    def UpdateRosters(self):
        ...
        for week in range(1, num_weeks+1): #assumes 16-week schedule
            ...
            for team in range(1, num_teams+1): #assumes 12-team league
                ...
                with open('C:/Users/mabur/Yahoo_API_Group2/rosters/week_'+str(week)+'/'+ file_name, 'w') as outfile:
                    json.dump(r, outfile)
                team =+ 1
...
def CurrentWeek():
    current_week = 1
    #with open('C:/Users/mabur/Yahoo_API_Group2/league.json', 'r') as fobj:
    #    info = json.load(fobj)
